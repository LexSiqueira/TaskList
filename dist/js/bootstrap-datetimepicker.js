...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.icons = {
			...
			leftArrow: this.fontAwesome ? 'fa-arrow-left' : (this.bootcssVer === 3 ? 'glyphicon-circle-arrow-left' : 'circle-arrow-left'),
			rightArrow: this.fontAwesome ? 'fa-arrow-right' : (this.bootcssVer === 3 ? 'glyphicon-circle-arrow-right' : 'circle-arrow-right')
		};
